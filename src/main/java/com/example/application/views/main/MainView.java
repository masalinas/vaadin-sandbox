 ...
 */
@PWA(name = "vaadin-sandbox", shortName = "vaadin-sandbox", enableInstallPrompt = false)
@Theme(themeFolder = "vaadin-sandbox")
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "vaadin-sandbox logo"));
        logoLayout.add(new H1("vaadin-sandbox"));
