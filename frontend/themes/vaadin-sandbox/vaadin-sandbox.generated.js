...
window.Vaadin.Flow['_vaadintheme_vaadin-sandbox_globalCss'] = window.Vaadin.Flow['_vaadintheme_vaadin-sandbox_globalCss'] || [];
export const applyTheme = (target) => {
  
  const injectGlobal = (window.Vaadin.Flow['_vaadintheme_vaadin-sandbox_globalCss'].length === 0) || (!window.Vaadin.Flow['_vaadintheme_vaadin-sandbox_globalCss'].includes(target) && target !== document);
  if (injectGlobal) {
